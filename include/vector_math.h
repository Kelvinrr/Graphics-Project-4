...
void v3_zero(V3 vector){
    vector[0] = 0;
    vector[1] = 0;
    vector[2] = 0;
}

void v3_copy(V3 in, V3 out){
    out[0] = in[0];
    out[1] = in[1];
    out[2] = in[2];
}
...
void v3_subtract(V3 a, V3 b, V3 c){
    c[0] = a[0] - b[0];
    c[1] = a[1] - b[1];
    c[2] = a[2] - b[2];
}
...
void v3_scale(V3 a, double s, V3 b){
    b[0] = s * a[0];
    b[1] = s * a[1];
    b[2] = s * a[2];
}
